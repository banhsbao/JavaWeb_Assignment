...
import baohc.product.ProductDAO;
import baohc.product.ProductDTO;
...
public class LoadProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = listmapping.get(SHOPPING_PAGE);
        try {
            ...
            log("LoadProduct_SQLException " + sq.getMessage());
        } catch (NamingException ne) {
            log("LoadProduct_NamingException" + ne.getMessage());
        }finally{
